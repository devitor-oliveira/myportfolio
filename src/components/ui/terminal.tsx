...
export const Terminal = ({
	...
	const content = (
		<div
			ref={containerRef}
			className={cn(
				'border-border bg-background flex flex-col z-0 h-full max-h-100 w-full max-w-lg rounded-xl border',
				className
			)}
		>
			...
			<pre className="p-4 flex min-h-0 flex-1 flex-col overflow-hidden">
				<code className="flex min-h-0 flex-1 flex-col overflow-hidden">
					{wrappedChildren}
				</code>
			</pre>
		</div>
